...
/** Minimal hub tile for the item pickup log: just an on/off toggle. */
public class GuiItemLog extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(this.fontRendererObj, "Item-log", cx, titleY, 0x55FF55);
        drawCenteredString(this.fontRendererObj, "Lille \"+N vare\" notifikation nederst til højre.", cx, titleY + 12, 0xAAAAAA);
